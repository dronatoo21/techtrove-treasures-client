                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 dark:bg-transparent dark:border-2 dark:text-white">
                  <form onSubmit={handleLogin} className="card-body">
                    <div className="form-control">
                      ...
                      <input type="email" placeholder="email" name="eamil" className="input input-bordered  dark:bg-transparent  dark:border-white" required />
                    </div>
                    <div className="form-control">
                      <label className="label">
                      ...
                      <div className="relative">
                        <input type={showPass ? "text" : "password"} placeholder="password" name="password" className="input input-bordered w-full dark:bg-transparent  dark:border-white" required />
